...
mma8451_ns = cg.esphome_ns.namespace("mma8451")
MMA8451Component = mma8451_ns.class_(
    "MMA8451Component", cg.PollingComponent, i2c.I2CDevice
)
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(MMA8451Component),
